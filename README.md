...
1. Run `/plugin` and select **Manage marketplaces** > **Add marketplace**
2. Enter `jondeibel/git-workflow`
3. Run `/plugin` and select **Install a plugin**
4. Select `gw@git-workflow`
